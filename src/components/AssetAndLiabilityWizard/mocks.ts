export const fillDetailsInitialValues = {
  bankName: "",
  accountType: "",
  country: "",
  currency: "",
...
export const bankAccountTypes = [
  {
    id: "secure",
    title: "Securely Link Account",
    description:
      "Connect to your account to securely sync your assets and liabilities",
  },
  {
    id: "manual",
    title: "Add Manually",
    description: "Enter assets and liabilities data to calculate net-worth",
  },
]
...
export const currencies = countries.map((country) => ({
