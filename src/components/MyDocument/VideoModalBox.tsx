...
import { CloseIcon, VideoPlayer } from "~/components"
    ...
    <Fragment>
      <Modal isOpen={show} onClose={onClose} size="full">
        ...
        <ModalContent margin="0" top="0">
          ...
          <ModalBody p="0">
            <VideoPlayer url={VideoURL} type={VideoType} showPlayBtn={true} />
          </ModalBody>
        </ModalContent>
      </Modal>
    </Fragment>
