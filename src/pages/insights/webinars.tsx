...
function WebinarsScreen() {
  ...
  const { data, error } = useSWR<InsightsWithPagination>(
    [`/api/portfolio/insights/webinars?currentPage=${currentPage}`, lang],
    (url, lang) =>
      fetch(url, {
        headers: {
...
export default withPageAuthRequired(WebinarsScreen)
